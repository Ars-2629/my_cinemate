...
<ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
   <li>
        <a href="https://www.facebook.com/rahilsiddiqui5859?mibextid=ZbWKwL" target="_blank" rel='noreferrer' className="mr-4 hover:underline md:mr-6 ">Facebook</a>
    </li>
    <li>
        <a href="https://instagram.com/rahil6546?igshid=MzNlNGNkZWQ4Mg==" target="_blank" rel='noreferrer' className="mr-4 hover:underline md:mr-6 ">Instagram</a>
    </li>
    <li>
    ...
    <li>
        <a href="https://www.youtube.com/results?search_query=villbuty" target="_blank" rel='noreferrer' className="mr-4 hover:underline md:mr-6">Youtube</a>
    </li>
    <li>
